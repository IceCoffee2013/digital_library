		...
		<c:when test="${cart.cartNotEmpty}">
			...
			<form action="cart" method="post">
				<table class="table table-striped" align="center" border="1">
					...
					<c:forEach items="${cart.bookList}" var="book">
						<tr>
							...
							<td>${book.author}</td>
							<td>${book.year}</td>
							<td align="center"><input class="btn" type="checkbox" name="book"
													  value="${book.id}"></td>
						</tr>
					</c:forEach>
					<%--<tr>--%>
						...
						<%--<td></td>--%>
						<%--<td></td>--%>
						<%--<td align="center"><input class="btn" type="submit" name="action"--%>
												  <%--value="remove"></td>--%>
					<%--</tr>--%>
					<%--<tr>--%>
						<%--<td></td>--%>
                ...
                <div class="pull-right">
                    ...
                    <input class="btn" type="submit" name="action" value="checkout">
                </div>
			</form>
		</c:when>
		<c:otherwise>
